...
class MetadataTrustCheckBootTest
{
  ...
  SamlProviderProvisioning<HostedServiceProviderService, LocalServiceProviderConfiguration, ServiceProviderMetadata, IdentityProviderMetadata, ExternalIdentityProviderConfiguration> samlProvisioning;
  ...
  void setUp()
  {
    ...
    trustCheckProvider = new ExternalIdentityProviderConfiguration().setAlias("dual")
  ...
  @Test
  void metadataTrustCheckWorks() throws Exception
  {
  ...
  @Test
  void metadataTrustCheckFails() throws Exception
  {
  ...
  @Test
  void staticKeysAreAdded() throws Exception
  {
    trustCheckProvider.setVerificationKeys(asList(SimpleSamlPhpTestKeys.getSimpleSamlPhpKeyData().getCertificate()))
    ...
    IdentityProviderMetadata provider = samlProvisioning.getHostedProvider().getRemoteProvider("login.run.pivotal.io");
    List<SigningKey> keys = provider.getIdentityProvider().getSigningKeys();
  ...
  private boolean hasKey(List<SigningKey> keys, String certificate)
  {
    return keys.stream().anyMatch(k -> certificate.equals(k.getCertificate()));
  }
