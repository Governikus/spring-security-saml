...
public enum ExamplePemKey
{
  ...
  SP_RSA_KEY("-----BEGIN RSA PRIVATE KEY-----\n" + "Proc-Type: 4,ENCRYPTED\n"
  ...
  IDP_RSA_KEY("-----BEGIN RSA PRIVATE KEY-----\n" + "Proc-Type: 4,ENCRYPTED\n"
  ...
  {
    return new SigningKey(alias, getPrivate(), getPublic(), getPassphrase());
  }

  public EncryptionKey getEncryptionKey(String alias)
  {
    return new EncryptionKey(alias, getPrivate(), getPublic(), getPassphrase());
  }
  ...
  public SigningKey getPublicSigningKey(String alias)
  {
    return new SigningKey(alias, getPublic());
  }
}
