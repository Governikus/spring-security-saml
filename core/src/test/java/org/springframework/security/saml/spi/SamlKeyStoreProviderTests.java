...
class SamlKeyStoreProviderTests
{
  ...
  void test_example()
  {
    new SamlKeyStoreProvider()
    {}.getKeyStore(RSA_TEST_KEY.getSigningKey("alias"));
  }
  ...
  {
    new SamlKeyStoreProvider()
    {}.getKeyStore(IDP_RSA_KEY.getSigningKey("alias"));
  }
  ...
  {
    new SamlKeyStoreProvider()
    {}.getKeyStore(SP_RSA_KEY.getSigningKey("alias"));
  }
}
