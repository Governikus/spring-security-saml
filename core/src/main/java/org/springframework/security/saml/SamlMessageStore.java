 ...
 * @param <H> - the specific implementation of the store
 */
public interface SamlMessageStore<T extends Saml2Object, H>
{
   ...
   */
  T getMessage(H holder, String id);
   ...
   */
  T removeMessage(H holder, String id);
   ...
   */
  T addMessage(H holder, String id, T message);
