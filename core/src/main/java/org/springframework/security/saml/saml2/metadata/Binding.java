  ...
  public static Binding fromUrn(URI other)
  {
    ...
    switch (type)
    {
      ...
      case POST_SIMPLE_SIGN:
        return Binding.POST_SIMPLE_SIGN;
      case PAOS:
        return Binding.PAOS;
      case SOAP:
        return Binding.SOAP;
      ...
      case REQUEST_INITIATOR:
        return Binding.REQUEST_INITIATOR;
      case SAML_1_0_BROWSER_ARTIFACT:
        return Binding.SAML_1_0_BROWSER_ARTIFACT;
      case SAML_1_0_BROWSER_POST:
        return Binding.SAML_1_0_BROWSER_POST;
      case CUSTOM:
        return new Binding(other, type);
    }
