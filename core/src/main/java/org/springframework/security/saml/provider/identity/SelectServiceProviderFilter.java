...
public class SelectServiceProviderFilter extends
  SamlFilter<HostedIdentityProviderService, LocalIdentityProviderConfiguration, IdentityProviderMetadata, ServiceProviderMetadata, ExternalServiceProviderConfiguration>
{
  ...
  private static final Log log = LogFactory.getLog(SelectServiceProviderFilter.class);

  private final RequestMatcher requestMatcher;

  private String selectTemplate = "/templates/spi/select-provider.vm";

  public SelectServiceProviderFilter(SamlProviderProvisioning<HostedIdentityProviderService, LocalIdentityProviderConfiguration, IdentityProviderMetadata, ServiceProviderMetadata, ExternalServiceProviderConfiguration> provisioning)
  {
  ...
  {
    UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(getProvisioning().getHostedProvider()
                                                                                       .getConfiguration()
                                                                                       .getBasePath());
