...
public interface SamlValidator
{
   ...
   */
  Signature validateSignature(Saml2Object saml2Object, List<SigningKey> verificationKeys) throws SignatureException;
   ...
   * @param requestContext can be <null>.
   * @throws ValidationException if validation failed. Details in the exception.
   */
  void validate(Saml2Object saml2Object, HostedProviderService<?, ?, ?, ?> provider, RequestContext requestContext)
